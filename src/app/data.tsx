...
export const Services = [
  {
    ...
    icon: <IoCodeSlash className="text-3xl text-btn" />,
  },
  {
    ...
    icon: <FaMobile className="text-2xl text-btn" />,
  },
  {
    title: "UI/UX Design",
    description:
    ...
    icon: <SiAltiumdesigner className="text-3xl text-btn" />,
  },
  {
    ...
    icon: <FaServer className="text-2xl text-btn" />,
  },
];
